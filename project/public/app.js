...
function loadWeeklySummary() {
  ...
  document.getElementById(
    "weekly-avg-hr"
  ).innerHTML = `${mockWeeklyData.avg} <span class="text-lg font-medium text-gray-600">bpm</span>`;
  document.getElementById(
    "weekly-min-hr"
  ).innerHTML = `${mockWeeklyData.min} <span class="text-lg font-medium text-gray-600">bpm</span>`;
  document.getElementById(
    "weekly-max-hr"
  ).innerHTML = `${mockWeeklyData.max} <span class="text-lg font-medium text-gray-600">bpm</span>`;
}
...
function handleSaveAccount(e) {
  ...
  console.log("Saving account info (mock):", {
    name: newName,
...
function handleSaveMeasurements(e) {
  ...
  mockSettings.frequency = document.getElementById(
